...
namespace CYM
{
    public class SysConst
    {
        ...
        //加载提示
        public const string Prefix_Lang_LoadTip = "LoadTip_";
        //城市前缀
        ...
        //CYMCommon
        public static readonly string Dir_CYMCommon = "CYMCommon";
        //Resources
        ...
        //CYMCommon
        public static readonly string Path_CYMCommon = Path.Combine(Application.dataPath, Dir_CYMCommon);
        //Resources
        ...
        public static readonly string Path_TemplateConfig = Path.Combine(Path_CYMCommon, "_Res/Configs/TemplateFiles");
        #endregion

        #region 工程目录的相对路径
        public static readonly string RPath_Assets = "Assets/";
        public static readonly string RPath_Common = "Assets/CYMCommon/";
        ...
        public static readonly string RPath_InternalBundle = Path.Combine(RPath_Common, Dir_Bundles);
        public static readonly string RPath_TempCYMMonobehaviour = Path.Combine(RPath_Common, "_Res/Configs/TemplateFiles/CYMMonobehaviour.asset");
        public static readonly string RPath_TempMonobehaviour = Path.Combine(RPath_Common, "_Res/Configs/TemplateFiles/Monobehaviour.asset");
        public static readonly string RPath_TempCSharp = Path.Combine(RPath_Common, "_Res/Configs/TemplateFiles/CSharp.asset");
        #endregion
